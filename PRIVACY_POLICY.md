...
The Platform is designed so that creators can keep media files in storage systems they control (for example, Google Drive, Dropbox, and other connected providers).
...
- Video title, description, tags, visibility, category
...
- Limited provider configuration fields required to enable streaming/migration workflows

### 3.4 Usage and Technical Data

- IP address, approximate geolocation, user-agent/device data
- App logs, error logs, request timestamps
...
- During business transfers (merger, acquisition, restructuring), subject to applicable safeguards
