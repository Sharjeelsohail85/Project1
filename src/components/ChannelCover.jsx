      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center overflow-hidden select-text">
          ...
          >
            ...
            {/* Interactive Inline Editing Overlay */}
            {isInlineEditing && (
              <textarea
                value={config.text}
                ...
                className="absolute inset-0 z-[50] bg-transparent text-center focus:outline-none resize-none overflow-hidden select-all"
                style={{
                  ...getTextStyle(config.fontFamily || "Lilita One", config.textSize),
                  fontSize: `${config.textSize}rem`,
                  lineHeight: config.lineHeight,
