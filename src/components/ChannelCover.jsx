      ...
      {isEditing && (
        <div className="absolute right-4 top-16 z-30 w-[320px] bg-white p-6 rounded-[32px] border-4 border-black shadow-[8px_8px_0px_rgba(0,0,0,1)] flex flex-col gap-4 max-h-[480px] overflow-y-auto customizer-card select-text">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-[10px] font-black tracking-widest text-black/40 uppercase">Sticker Text</label>
            <textarea
              rows={2}
              value={config.text}
              onChange={(e) => updateConfig('text', e.target.value)}
              className="w-full bg-[#f3f3f6] hover:bg-[#eef0f4] transition border-2 border-transparent focus:border-black rounded-2xl font-bold font-sans text-xs p-3 focus:outline-none uppercase text-gray-800"
              placeholder="GOOD\nMORNING!"
            />
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-[10px] font-black tracking-widest text-black/40 uppercase">Font Family</label>
            <select
              value={config.fontFamily}
              onChange={(e) => updateConfig('fontFamily', e.target.value)}
              className="w-full bg-[#f3f3f6] hover:bg-[#eef0f4] transition border-2 border-transparent focus:border-black rounded-2xl font-bold font-sans text-xs p-3 focus:outline-none cursor-pointer text-gray-800"
            >
          ...
          <div className="flex flex-col gap-2.5">
            {[
              ...
              <div key={idx} className="flex flex-col gap-1">
                <label className="text-[10px] font-black tracking-widest text-black/40 uppercase">{item.label}</label>
          ...
          <div className="flex items-center gap-2 py-1 select-none cursor-pointer">
            ...
            />
            <label htmlFor="shadowTransparent" className="text-[10px] font-black tracking-widest text-black/40 uppercase cursor-pointer">
              Shadow Transparent
            </label>
          </div>
          ...
          <div className="space-y-3 pt-3 border-t-2 border-black/10">
            {[
              ...
              <div key={idx} className="flex flex-col gap-1">
                <div className="flex justify-between items-center text-[10px] font-black tracking-widest text-black/40 uppercase">
