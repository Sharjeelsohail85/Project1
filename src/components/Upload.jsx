        ...
        >
          ...
          >
            ...
            <Box
              ...
              sx={{ ...step2InputWrapperSx, flex: { xs: '1 1 100%', sm: '1 1 240px' }, width: 'auto', float: 'none', mb: 0, minWidth: 0, ml: 0 }}
            >
              <CatPrivacySelect
        ...
        <Box className="upload-toggles" sx={{ width: '100%', maxWidth: 690, mt: 1 }}>
          ...
          {isUploading ? (
            <HeartUploadLoader
              ...
              title="Uploading & Submitting Video..."
              subtitle="Please wait while we stream your video content to the server"
            />
          ) : null}
        </Box>
      </div>
